// ==============================================================
// File generated on Thu Apr 20 21:01:49 +0800 2023
...
localparam
    ...
    ADDR_CHOUT_V_DATA_0     = 7'h28,
    ADDR_CHOUT_V_CTRL       = 7'h2c,
    ADDR_KX_V_DATA_0        = 7'h30,
    ADDR_KX_V_CTRL          = 7'h34,
    ADDR_KY_V_DATA_0        = 7'h38,
    ADDR_KY_V_CTRL          = 7'h3c,
    ADDR_SX_V_DATA_0        = 7'h40,
    ADDR_SX_V_CTRL          = 7'h44,
    ADDR_SY_V_DATA_0        = 7'h48,
    ADDR_SY_V_CTRL          = 7'h4c,
    ADDR_MODE_V_DATA_0      = 7'h50,
    ADDR_MODE_V_CTRL        = 7'h54,
    ADDR_RELU_EN_V_DATA_0   = 7'h58,
    ADDR_RELU_EN_V_CTRL     = 7'h5c,
    ADDR_FEATURE_IN_DATA_0  = 7'h60,
    ADDR_FEATURE_IN_CTRL    = 7'h64,
    ADDR_W_DATA_0           = 7'h68,
    ADDR_W_CTRL             = 7'h6c,
    ADDR_BIAS_DATA_0        = 7'h70,
    ADDR_BIAS_CTRL          = 7'h74,
    ADDR_FEATURE_OUT_DATA_0 = 7'h78,
    ADDR_FEATURE_OUT_CTRL   = 7'h7c,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
