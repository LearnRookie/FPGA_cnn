# ==============================================================
# File generated on Thu Apr 20 21:03:24 +0800 2023
# Vivado(TM) HLS - High-Level Synthesis from C, C++ and SystemC v2018.3 (64-bit)
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
# IP Build 2404404 on Fri Dec  7 01:43:56 MST 2018
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved.
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/F_Software/Vivado2018.3/Vivado/2018.3/win64/tools/fpo_v7_0"

set ::env(PATH) "$::env(PATH);C:/F_Software/Vivado2018.3/Vivado/2018.3/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/F_Software/Vivado2018.3/Vivado/2018.3/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/F_Software/Vivado2018.3/Vivado/2018.3/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/F_Software/Vivado2018.3/Vivado/2018.3/win64/tools/dds_v6_0"
...
if {[file isfile Conv.autotvin.dat]} {
	file delete -force Conv.autotvin.dat
}

if {[file isfile Conv.autotvout.dat]} {
	file delete -force Conv.autotvout.dat
}
