	...
	)//mode: 0:VALID, 1:SAME
{
	...
	#pragma HLS INTERFACE m_axi depth=3000000000 port=feature_out offset=slave
	#pragma HLS INTERFACE m_axi depth=3000000000 port=bias offset=slave
	#pragma HLS INTERFACE m_axi depth=3000000000 port=W offset=slave
	#pragma HLS INTERFACE m_axi depth=3000000000 port=feature_in offset=slave
