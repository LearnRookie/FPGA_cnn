...
tr.send<4>((char*)__xlx_apatb_param_feature_out, 1073741823, 3221225469);
}
#else
try {
...
if (__xlx_apatb_param_feature_out) {
  tr.import<4>((char*)__xlx_apatb_param_feature_out, 1073741823, 0);
}
