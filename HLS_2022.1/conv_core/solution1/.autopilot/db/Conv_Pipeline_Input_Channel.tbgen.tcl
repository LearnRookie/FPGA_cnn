set moduleName Conv_Pipeline_Input_Channel
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Conv_Pipeline_Input_Channel}
set C_modelType { void 0 }
set C_modelArgList {
	{ sum_1 float 32 regular  }
	{ gmem int 32 regular {axi_master 0}  }
	{ CHin int 16 regular  }
	{ trunc_ln57_cast int 62 regular  }
	{ CHout_cast6 int 16 regular  }
	{ zext_ln1073_1 int 16 regular  }
	{ tmp13 int 48 regular  }
	{ W int 64 regular  }
	{ sum_2_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sum_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "feature_in","offset": { "type": "dynamic","port_name": "feature_in","bundle": "control"},"direction": "READONLY"},{"cName": "W","offset": { "type": "dynamic","port_name": "W","bundle": "control"},"direction": "READONLY"},{"cName": "bias","offset": { "type": "dynamic","port_name": "bias","bundle": "control"},"direction": "READONLY"},{"cName": "feature_out","offset": { "type": "dynamic","port_name": "feature_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "CHin", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln57_cast", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "CHout_cast6", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln1073_1", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "tmp13", "interface" : "wire", "bitwidth" : 48, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ CHin sc_in sc_lv 16 signal 2 } 
	{ trunc_ln57_cast sc_in sc_lv 62 signal 3 } 
	{ CHout_cast6 sc_in sc_lv 16 signal 4 } 
	{ zext_ln1073_1 sc_in sc_lv 16 signal 5 } 
	{ tmp13 sc_in sc_lv 48 signal 6 } 
	{ W sc_in sc_lv 64 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "CHin", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "CHin", "role": "default" }} , 
 	{ "name": "trunc_ln57_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "trunc_ln57_cast", "role": "default" }} , 
 	{ "name": "CHout_cast6", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "CHout_cast6", "role": "default" }} , 
 	{ "name": "zext_ln1073_1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "zext_ln1073_1", "role": "default" }} , 
 	{ "name": "tmp13", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "tmp13", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "Conv_Pipeline_Input_Channel",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2", "EstimateLatencyMax" : "327691",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "trunc_ln57_cast", "Type" : "None", "Direction" : "I"},
			{"Name" : "CHout_cast6", "Type" : "None", "Direction" : "I"},
			{"Name" : "zext_ln1073_1", "Type" : "None", "Direction" : "I"},
			{"Name" : "tmp13", "Type" : "None", "Direction" : "I"},
			{"Name" : "W", "Type" : "None", "Direction" : "I"},
			{"Name" : "sum_2_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "Input_Channel", "PipelineType" : "UPC",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U2", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	Conv_Pipeline_Input_Channel {
		...
		trunc_ln57_cast {Type I LastRead 0 FirstWrite -1}
		CHout_cast6 {Type I LastRead 0 FirstWrite -1}
		zext_ln1073_1 {Type I LastRead 0 FirstWrite -1}
		tmp13 {Type I LastRead 0 FirstWrite -1}
		W {Type I LastRead 0 FirstWrite -1}
		sum_2_out {Type O LastRead -1 FirstWrite 15}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "327691"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "327691"}
]}
...
set Spec2ImplPortList { 
	...
	CHin { ap_none {  { CHin in_data 0 16 } } }
	trunc_ln57_cast { ap_none {  { trunc_ln57_cast in_data 0 62 } } }
	CHout_cast6 { ap_none {  { CHout_cast6 in_data 0 16 } } }
	zext_ln1073_1 { ap_none {  { zext_ln1073_1 in_data 0 16 } } }
	tmp13 { ap_none {  { tmp13 in_data 0 48 } } }
