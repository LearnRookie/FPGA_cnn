...
AUTOPILOT_ROOT := C:/F_Software/vivado/Vitis_HLS/2022.1
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := C:/F_Software/vivado/Vitis_HLS/2022.1/tps/win64/msys64/mingw64/bin
endif
...
$(ObjDir)/conv_core.cpp_pre.cpp.tb.o : conv_core.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling conv_core.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
