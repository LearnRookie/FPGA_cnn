; ModuleID = 'C:/D_File/FPGAprj/shousiACC/HLS/conv_core/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %malloccall3 = tail call i8* @malloc(i64 8000000000)
  %feature_out_copy = bitcast i8* %malloccall3 to [2000000000 x float]*
  ...
  %3 = bitcast float* %feature_out to [2000000000 x float]*
  call fastcc void @copy_in([2147483647 x float]* nonnull %0, [2147483647 x float]* %feature_in_copy, [2147483647 x float]* nonnull %1, [2147483647 x float]* %W_copy, [2147483647 x float]* nonnull %2, [2147483647 x float]* %bias_copy, [2000000000 x float]* nonnull %3, [2000000000 x float]* %feature_out_copy)
  ...
  %7 = getelementptr inbounds [2000000000 x float], [2000000000 x float]* %feature_out_copy, i32 0, i32 0
  ...
  call void @copy_back([2147483647 x float]* %0, [2147483647 x float]* %feature_in_copy, [2147483647 x float]* %1, [2147483647 x float]* %W_copy, [2147483647 x float]* %2, [2147483647 x float]* %bias_copy, [2000000000 x float]* %3, [2000000000 x float]* %feature_out_copy)
...
define internal fastcc void @copy_in([2147483647 x float]* noalias readonly, [2147483647 x float]* noalias, [2147483647 x float]* noalias readonly, [2147483647 x float]* noalias, [2147483647 x float]* noalias readonly, [2147483647 x float]* noalias, [2000000000 x float]* noalias readonly, [2000000000 x float]* noalias) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a2000000000f32([2000000000 x float]* %7, [2000000000 x float]* %6)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0a2000000000f32([2000000000 x float]* noalias, [2000000000 x float]* noalias readonly) unnamed_addr #2 {
entry:
  %2 = icmp eq [2000000000 x float]* %0, null
  %3 = icmp eq [2000000000 x float]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %copy
  %for.loop.idx1 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr = getelementptr [2000000000 x float], [2000000000 x float]* %0, i64 0, i64 %for.loop.idx1
  %src.addr = getelementptr [2000000000 x float], [2000000000 x float]* %1, i64 0, i64 %for.loop.idx1
  %5 = load float, float* %src.addr, align 4
  store float %5, float* %dst.addr, align 4
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx1, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, 2000000000
  br i1 %exitcond, label %for.loop, label %ret
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([2147483647 x float]* noalias, [2147483647 x float]* noalias readonly, [2147483647 x float]* noalias, [2147483647 x float]* noalias readonly, [2147483647 x float]* noalias, [2147483647 x float]* noalias readonly, [2000000000 x float]* noalias, [2000000000 x float]* noalias readonly) unnamed_addr #3 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a2000000000f32([2000000000 x float]* %6, [2000000000 x float]* %7)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([2147483647 x float]* noalias, [2147483647 x float]* noalias readonly, [2147483647 x float]* noalias, [2147483647 x float]* noalias readonly, [2147483647 x float]* noalias, [2147483647 x float]* noalias readonly, [2000000000 x float]* noalias, [2000000000 x float]* noalias readonly) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a2000000000f32([2000000000 x float]* %6, [2000000000 x float]* %7)
  ret void
}
...
entry:
  ...
  %17 = bitcast float* %13 to [2000000000 x float]*
  call void @copy_out([2147483647 x float]* null, [2147483647 x float]* %14, [2147483647 x float]* null, [2147483647 x float]* %15, [2147483647 x float]* null, [2147483647 x float]* %16, [2000000000 x float]* null, [2000000000 x float]* %17)
  ...
  %21 = bitcast [2000000000 x float]* %17 to float*
  ...
  call void @copy_in([2147483647 x float]* null, [2147483647 x float]* %14, [2147483647 x float]* null, [2147483647 x float]* %15, [2147483647 x float]* null, [2147483647 x float]* %16, [2000000000 x float]* null, [2000000000 x float]* %17)
  ret void
}
