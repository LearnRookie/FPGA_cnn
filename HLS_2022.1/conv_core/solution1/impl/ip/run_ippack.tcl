...
set solution_dir "C:/D_File/FPGAprj/shousiACC/HLS_2022.1/conv_core/solution1"
set debug_dir "C:/D_File/FPGAprj/shousiACC/HLS_2022.1/conv_core/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {Conv_fmul_32ns_32ns_32_4_max_dsp_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST R 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST R 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 CHin W 0x0 "Data signal of CHin" {{0 16 CHin W 0 "Bit 15 to 0 of CHin"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 Hin W 0x0 "Data signal of Hin" {{0 16 Hin W 0 "Bit 15 to 0 of Hin"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 Win W 0x0 "Data signal of Win" {{0 16 Win W 0 "Bit 15 to 0 of Win"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 CHout W 0x0 "Data signal of CHout" {{0 16 CHout W 0 "Bit 15 to 0 of CHout"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 Kx W 0x0 "Data signal of Kx" {{0 8 Kx W 0 "Bit 7 to 0 of Kx"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 Ky W 0x0 "Data signal of Ky" {{0 8 Ky W 0 "Bit 7 to 0 of Ky"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 Sx W 0x0 "Data signal of Sx" {{0 8 Sx W 0 "Bit 7 to 0 of Sx"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 Sy W 0x0 "Data signal of Sy" {{0 8 Sy W 0 "Bit 7 to 0 of Sy"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 mode W 0x0 "Data signal of mode" {{0 1 mode W 0 "Bit 0 to 0 of mode"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 relu_en W 0x0 "Data signal of relu_en" {{0 1 relu_en W 0 "Bit 0 to 0 of relu_en"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 feature_in_1 W 0x0 "Data signal of feature_in" {{0 32 feature_in W 0 "Bit 31 to 0 of feature_in"}}} {0x64 feature_in_2 W 0x0 "Data signal of feature_in" {{0 32 feature_in W 0 "Bit 63 to 32 of feature_in"}}} {0x6c W_1 W 0x0 "Data signal of W" {{0 32 W W 0 "Bit 31 to 0 of W"}}} {0x70 W_2 W 0x0 "Data signal of W" {{0 32 W W 0 "Bit 63 to 32 of W"}}} {0x78 bias_1 W 0x0 "Data signal of bias" {{0 32 bias W 0 "Bit 31 to 0 of bias"}}} {0x7c bias_2 W 0x0 "Data signal of bias" {{0 32 bias W 0 "Bit 63 to 32 of bias"}}} {0x84 feature_out_1 W 0x0 "Data signal of feature_out" {{0 32 feature_out W 0 "Bit 31 to 0 of feature_out"}}} {0x88 feature_out_2 W 0x0 "Data signal of feature_out" {{0 32 feature_out W 0 "Bit 63 to 32 of feature_out"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
source -notrace "C:/F_Software/vivado/Vitis_HLS/2022.1/common/scripts/ipxhls.tcl"
